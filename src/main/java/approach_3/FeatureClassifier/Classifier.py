...
file_path = '/Users/sujanshrestha/IdeaProjects/Feature_Extraction/src/main/java/approach_3/feature_csv_files/union/features.csv'
...
def get_input_output_features(local_df):
    ...
    input_feature = local_df.drop(['object', 'paretoOptimal'], axis=1)
